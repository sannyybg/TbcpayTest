...
def test_check_menu_elements(browser):
    ...
    allure.attach(browser.get_screenshot_as_png(), name="menuElements", attachment_type=AttachmentType.PNG)
...
def test_check_search(browser):
    ...
    allure.attach(browser.get_screenshot_as_png(), name="searchScreen", attachment_type=AttachmentType.PNG)


@allure.severity(allure.severity_level.MINOR)
def test_check_number_input(browser):
    tbc_page = TbcPayMainPage(browser)
    tbc_page.load()
    ...
    allure.attach(browser.get_screenshot_as_png(), name="numberInput", attachment_type=AttachmentType.PNG)

@allure.severity(allure.severity_level.MINOR)
def test_check_number_dropdownList(browser):
    tbc_page = TbcPayMainPage(browser)
    tbc_page.load()
    ...
    allure.attach(browser.get_screenshot_as_png(), name="dropDownList", attachment_type=AttachmentType.PNG)

@allure.severity(allure.severity_level.MINOR)
def test_select_meti10(browser):
    tbc_page = TbcPayMainPage(browser)
    tbc_page.load()
    ...
    allure.attach(browser.get_screenshot_as_png(), name="meti10Screen", attachment_type=AttachmentType.PNG)
...
def test_checkout(browser):
    ...
    allure.attach(browser.get_screenshot_as_png(), name="checkOutScreen", attachment_type=AttachmentType.PNG)
